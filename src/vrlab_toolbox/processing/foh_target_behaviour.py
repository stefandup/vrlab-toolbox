...
from vrlab_toolbox.processing.foh_config import TARGET_TYPES, TRIAL_NUMBERS, TRIAL_TYPES
from vrlab_toolbox.processing.input_data import ParticipantConfig
from vrlab_toolbox.processing.lsl import gather_xdf_data_streams
