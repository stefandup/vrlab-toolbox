...
from vrlab_toolbox import config as cfg
from vrlab_toolbox.cli.check_mobi_xdf import check_mobi_xdf as get_and_check_xdf
from vrlab_toolbox.processing import lsl as xdf
...
def run_lsl_pipeline(
    ...
    """
    Run FOH pipeline for LSL EDA, ECG and Behavioural (i.e. Target) data.
    Tries to be robust wrt missing data.
    """
    if not xdf_fn:
