...
def run_ecg_processing(
    ecg_raw, clean_method="biosppy", peak_detect_method="neurokit", sampling_rate=1000
):
...
def run_ecg_pipeline(
    opensignals_df: pd.DataFrame,
    vr_intervals: dict[str, tuple[float, float]],
