...
from vrlab_toolbox.processing import trial_intervals
...
from vrlab_toolbox.processing.pipeline import ProcessPhysiologyFallbackStrategy
...
class EDAProcessingError(ValueError):
