...
from mooi_toolbox.processing.longwalk_pipeline import build_longwalk_participant_output_schema
from mooi_toolbox.processing.longwalk_pipeline import run_pipeline as run_longwalk_pipeline
...
def main(input_folder: Path, output_folder: Path, verbose: bool, subject_id: str):
    ...
    out_file_parts = []
    physio_glob_str = "sub-*_task-longwalk_acq-physiology*_physio.mat"
