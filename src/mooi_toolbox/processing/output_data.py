...
class PipelineData():
    ...
    def __post_init__(self):
        self.subject_df_out = pd.DataFrame([{
             ...
             "Processing_Status" : self.status.get_as_text()
             }])
    ...
    def append_columns(self, data_in : pd.DataFrame, additional_columns : dict[str, pa.Column]) -> None:
        ...
        data_in_reset = data_in_reset.drop(
                columns=["Subject_ID", "Processing_Status"],
                errors="ignore"
            )
