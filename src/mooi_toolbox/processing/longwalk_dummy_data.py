...
from mooi_toolbox.processing.longwalk_behaviour import LONGWALK_EVENTS_LABELS
...
def generate_dummy_longwalk_participant(
    ...
    pulse_times = _trigger_pulse_times(TOTAL_DURATION_SECONDS, N_TRIGGER_PULSES, PULSE_MARGIN_SECONDS)
