...
| --- | --- | --- |
| BIDS conversion | `src/vrlab_toolbox/processing/bids.py`, `crane_bids.py`, `longwalk_bids.py` | [ ] |
...
| Crosscheck (backend + GUI) | `src/vrlab_toolbox/processing/bids_crosscheck.py`; `src/vrlab_toolbox/gui/bids_crosscheck_common.py`, `crane_bids_crosscheck_gui.py`, `foh_bids_crosscheck_gui.py`, `longwalk_bids_crosscheck_gui.py` | [ ] |
